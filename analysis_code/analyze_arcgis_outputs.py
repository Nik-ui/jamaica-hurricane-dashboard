...
<main>
  ...
  <aside>
    ...
    <div class="legend">
      ...
      <div class="legendRow"><span class="swatch" style="background:#1f6f8b"></span>Observed track</div>
      <div class="legendRow"><span class="swatch" style="background:#ad2f45"></span>Forecast track</div>
    </div>
...
const [atlanticX, atlanticY] = project(-75.1, 20.95);
